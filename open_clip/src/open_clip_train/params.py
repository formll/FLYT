...
def parse_args(args):
    ...
    # FLYT and M-FLYT params:
    parser.add_argument(
        "--flyt",
        default=False,
        action="store_true",
        help="If true, train FLYT."
    )
    parser.add_argument(
        "--downstream_batch_size", 
        type=int, 
        default=3072, 
        help="Downstream batch size per GPU."
    )
    parser.add_argument(
        "--scoring_lr", 
        type=float, 
    ...
    parser.add_argument(
        "--downstream-data-upsampling-factors",
        type=str,
        default=None,
        help="Similar to --train-data-upsampling-factors"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Parquet directory of scores.",
    )
    parser.add_argument(
        '--parquet_fields', 
        type=str, 
